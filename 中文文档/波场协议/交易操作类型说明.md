...
合约支持多种类型，是LITETOKENS网络中的基本单位。下面详细介绍每种合约及参数。\
...
## <h2 id="8">8.购买发行的Token ParticipateAssetIssueContract</h2>  
   ...
   `amount`：购买发行Token使用XLT的数量，单位是 sun。  
